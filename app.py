    ...
    def generate():
        with app.app_context():
            ...
            if len(emotion_result) > 0:
                most_repeated = most_repeated_item(emotion_result)
                print(f"The most repeated item is: {most_repeated}")
                if(most_repeated==1):
                    resp ="HAPPY"
                    ...
                    resp="Fearful"
                elif(most_repeated==5):
                    resp="Neutral"
                elif(most_repeated==6):
                    resp="Sad"
                elif(most_repeated==7):
                    resp="Surprised"
                else:
                    resp="NONE"
                cache['emotion'] = []
