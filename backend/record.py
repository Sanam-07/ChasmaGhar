        ...
        if len(list(obj_keys)) > 0:
                ...
                if (current_time - prev_time).total_seconds() > 0.5:
                    ...
                    if detect_result:
                        ...
                        new_emotion_result = 0
                        if(emotion_result=="Happy"):
                            new_emotion_result =1
                        elif(emotion_result == "Angry"):
                            new_emotion_result=2
                        elif(emotion_result =="Disgusted"):
                            new_emotion_result=3
                        elif (emotion_result=="Fearful"):
                            new_emotion_result=4
                        elif(emotion_result=="Neutral"):
                            new_emotion_result=5
                        elif(emotion_result=="Sad"):
                            new_emotion_result=6
                        elif(emotion_result=="Surprised"):
                            new_emotion_result=7
                        else:
                            new_emotion_result=0
                        cache['emotion'].append(new_emotion_result)
                    print("from emotion")
                    print(cache)
